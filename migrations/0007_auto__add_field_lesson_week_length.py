...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lesson.week_length'
        db.add_column(u'support_lesson', 'week_length',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lesson.week_length'
        db.delete_column(u'support_lesson', 'week_length')
