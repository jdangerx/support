...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'support_post', 'date_time')

        # Adding field 'Post.published'
        db.add_column(u'support_post', 'published',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'support_post', 'date_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Deleting field 'Post.published'
        db.delete_column(u'support_post', 'published')
