...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WechatSummary'
        db.create_table(u'support_wechatsummary', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('published', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'support', ['WechatSummary'])


    def backwards(self, orm):
        # Deleting model 'WechatSummary'
        db.delete_table(u'support_wechatsummary')
    ...
    models = {
        ...
        u'support.wechatsummary': {
            'Meta': {'object_name': 'WechatSummary'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
