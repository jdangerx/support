...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LessonCategoryType'
        db.create_table(u'support_lessoncategorytype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'support', ['LessonCategoryType'])

        # Deleting field 'LessonCategory.name'
        db.delete_column(u'support_lessoncategory', 'name')
    ...
    def backwards(self, orm):
        # Deleting model 'LessonCategoryType'
        db.delete_table(u'support_lessoncategorytype')

        # Adding field 'LessonCategory.name'
        db.add_column(u'support_lessoncategory', 'name',
                      self.gf('django.db.models.fields.CharField')(default='\xe8\xaf\xbe\xe6\x96\x87\xe5\xbc\x95\xe5\x85\xa5', max_length=200),
                      keep_default=False)
    ...
    models = {
        ...
        u'support.lessoncategory': {
            ...
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['support.LessonCategoryType']"})
        },
