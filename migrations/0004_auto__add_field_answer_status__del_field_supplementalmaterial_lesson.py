...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'support_answer', 'status',
                      self.gf('django.db.models.fields.CharField')(default='P', max_length=1),
                      keep_default=False)

        # Deleting field 'SupplementalMaterial.lesson'
        db.delete_column(u'support_supplementalmaterial', 'lesson_id')
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'support_answer', 'status')

        # Adding field 'SupplementalMaterial.lesson'
        db.add_column(u'support_supplementalmaterial', 'lesson',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['support.Lesson']),
                      keep_default=False)
