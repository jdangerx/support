...
urlpatterns = patterns('',
    ...
    url(r'^question/(?P<question_id>\d+)/edit/$', views.edit_question, 
        name='edit_question'),
    url(r'^question/(?P<question_id>\d+)/flag/$', views.flag_question, 
        name='flag_question'),
    ...
    url(r'^answer/(?P<answer_id>\d+)/edit/$', views.edit_answer, 
        name='edit_answer'),
    url(r'^question/(?P<answer_id>\d+)/flag/$', views.flag_answer, 
        name='flag_answer'),
